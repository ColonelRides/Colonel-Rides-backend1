...
// Render (like most hosts) sits the app behind a reverse proxy — without
// this, req.ip returns the proxy's own address for every request, which
// would make rate limiting (see routes/auth.js) treat all traffic as a
// single client instead of distinguishing real users from each other.
// "1" trusts exactly one hop, matching a standard single-proxy setup.
